...
//2.1 changes end	
        ...
        if ($smooth_slider['image_only'] == '1') {
            ...
            if ($permalink != '') {
				...
				<p class="smooth_more"><a href="' . $permalink . '" ' . $smooth_slider_css['smooth_slider_p_more'] . '>' .  '</a></p>
<div class="div-button"><a class="button-read" href="' . $permalink . '" ' . '>' . $smooth_slider['more'] . '</a></div>
...
function smooth_slider_get_default($slider_handle, $r_array, $slider_id = '', $echo = '1') {
    ...
    if (isset($smooth_sldr_j) && $smooth_sldr_j >= 1) : //is slider empty?
        ...
        if ($smooth_slider['goto_slide'] == 1 or $smooth_slider['goto_slide'] == 2 or $smooth_slider['goto_slide'] == 4) {
            $html .= '<div id="' . $slider_handle . '_nav" class="smooth_nav smooth_nav-my-style"></div>';
        }
