...
function cis_init() {
    ...
    $cis_options['speediconsanimation'] = "1.0";
    $cis_options['speediconshoveranimation'] = "0.6";
    $cis_options['speedimagehoveranimation'] = "1.0";
...
function add_image_wrap_class($content) {
    ...
    $myexcerpt = wph_cut_by_words(300, esc_html(strip_tags(strip_shortcodes(get_the_content('')))));
    $myexcerpt =  preg_replace( "/\r|\n/", "", $myexcerpt  );
    $myexcerpt = rawurlencode($myexcerpt);
    ...
    foreach ($networks as $network) {
        ...
        case "linkedin":
            ...
            break;           
        case "tumblr":
            $temp .= "<a rel='nofollow' href=\"https://www.tumblr.com/widgets/share/tool?canonicalUrl={$myurl}&posttype=link&title={$mytitle}&caption={$myexcerpt}\" onclick=\"newMyWindow(this.href); return false;\"><img title='{$iconstitle}' width='{$cis_options['iconssize']}' height='{$cis_options['iconssize']}' src='" . $purl . '/cool-image-share/img/'.$cis_options['theme'].'/tumblr.png'."' /></a>";
            break;  
        case "odnoklassniki":
...
function cis_print_style() {
    $cis_options = get_option('cis_options');
if (!isset($cis_options['speediconsanimation'])) {
    $cis_options['speediconsanimation']='1.0';
    update_option('cis_options', $cis_options);
}
if (!isset($cis_options['speediconshoveranimation'])) {
    $cis_options['speediconshoveranimation']='0.6';
    update_option('cis_options', $cis_options);
}
if (!isset($cis_options['speedimagehoveranimation'])) {
    $cis_options['speedimagehoveranimation']='1.0';
    update_option('cis_options', $cis_options);
}    
?>
<style>
.image-share-wrap .animated{-webkit-animation-duration:<?php echo $cis_options['speediconsanimation']; ?>s!important;animation-duration:<?php echo $cis_options['speediconsanimation']; ?>s!important;}
.hidden-share{position:absolute;display:none;z-index:100;}
.hidden-share a{text-decoration:none !important;border:0!important;outline:0 !important;}
.hidden-share a:active,.hidden-share a:focus{outline:0 !important;box-shadow:none!important;}
.mycenter{text-align:left;}
.hidden-share img:focus,.hidden-share img:active{outline:0 !important;box-shadow:none!important;}
.hidden-share img{-webkit-transition: all <?php echo $cis_options['speediconshoveranimation']; ?>s ease;-moz-transition: all <?php echo $cis_options['speediconshoveranimation']; ?>s ease;-o-transition: all <?php echo $cis_options['speediconshoveranimation']; ?>s ease;-ms-transition: all <?php echo $cis_options['speediconshoveranimation']; ?>s ease;transition: all <?php echo $cis_options['speediconshoveranimation']; ?>s ease;line-height:1!important;padding:0!important;margin:0!important;vertical-align:top!important;border-radius:0px!important;box-shadow:none!important;border:0!important;outline:0;!important;max-width:100%!important;
...
.cool-image-share{-webkit-transition: all <?php echo $cis_options['speedimagehoveranimation']; ?>s ease;-moz-transition: all <?php echo $cis_options['speedimagehoveranimation']; ?>s ease;-o-transition: all <?php echo $cis_options['speedimagehoveranimation']; ?>s ease;-ms-transition: all <?php echo $cis_options['speedimagehoveranimation']; ?>s ease;transition: all <?php echo $cis_options['speedimagehoveranimation']; ?>s ease;}
...
if (isset($_POST['submit'])) {
    ...
    $cis_options['speediconsanimation'] = $_POST['speediconsanimation'];
    $cis_options['speediconshoveranimation'] = $_POST['speediconshoveranimation'];
    $cis_options['speedimagehoveranimation'] = $_POST['speedimagehoveranimation'];
...
<div class="postbox">
    ...
    <h3 style="border-bottom: 1px solid #EEE;background: #f7f7f7;"><span class="tcode"><?php _e('Effects and Animations', 'cool-image-share'); ?></span></h3>
      ...
      &nbsp;&nbsp;&nbsp;<?php _e("Speed:", 'cool-image-share') ?>
      <select name="speediconsanimation">
            <option value="0.1" <?php if ($cis_options['speediconsanimation'] == '0.1') echo "selected='selected'" ?>>0.1</option>
            <option value="0.2" <?php if ($cis_options['speediconsanimation'] == '0.2') echo "selected='selected'" ?>>0.2</option>
            <option value="0.3" <?php if ($cis_options['speediconsanimation'] == '0.3') echo "selected='selected'" ?>>0.3</option>
            <option value="0.4" <?php if ($cis_options['speediconsanimation'] == '0.4') echo "selected='selected'" ?>>0.4</option>
            <option value="0.5" <?php if ($cis_options['speediconsanimation'] == '0.5') echo "selected='selected'" ?>>0.5</option>
            <option value="0.6" <?php if ($cis_options['speediconsanimation'] == '0.6') echo "selected='selected'" ?>>0.6</option>
            <option value="0.7" <?php if ($cis_options['speediconsanimation'] == '0.7') echo "selected='selected'" ?>>0.7</option>
            <option value="0.8" <?php if ($cis_options['speediconsanimation'] == '0.8') echo "selected='selected'" ?>>0.8</option>
            <option value="0.9" <?php if ($cis_options['speediconsanimation'] == '0.9') echo "selected='selected'" ?>>0.9</option>
            <option value="1.0" <?php if ($cis_options['speediconsanimation'] == '1.0') echo "selected='selected'" ?>>1.0</option>
            <option value="1.1" <?php if ($cis_options['speediconsanimation'] == '1.1') echo "selected='selected'" ?>>1.1</option>
            <option value="1.2" <?php if ($cis_options['speediconsanimation'] == '1.2') echo "selected='selected'" ?>>1.2</option>
            <option value="1.3" <?php if ($cis_options['speediconsanimation'] == '1.3') echo "selected='selected'" ?>>1.3</option>
            <option value="1.4" <?php if ($cis_options['speediconsanimation'] == '1.4') echo "selected='selected'" ?>>1.4</option>
            <option value="1.5" <?php if ($cis_options['speediconsanimation'] == '1.5') echo "selected='selected'" ?>>1.5</option>
            <option value="1.6" <?php if ($cis_options['speediconsanimation'] == '1.6') echo "selected='selected'" ?>>1.6</option>
            <option value="1.7" <?php if ($cis_options['speediconsanimation'] == '1.7') echo "selected='selected'" ?>>1.7</option>
            <option value="1.8" <?php if ($cis_options['speediconsanimation'] == '1.8') echo "selected='selected'" ?>>1.8</option>
            <option value="1.9" <?php if ($cis_options['speediconsanimation'] == '1.9') echo "selected='selected'" ?>>1.9</option>
            <option value="2.0" <?php if ($cis_options['speediconsanimation'] == '2.0') echo "selected='selected'" ?>>2.0</option>
      </select>
      (<?php _e("in seconds", 'cool-image-share') ?>)
      ...
      &nbsp;&nbsp;&nbsp;<?php _e("Speed:", 'cool-image-share') ?>
      <select name="speediconshoveranimation">
            <option value="0.1" <?php if ($cis_options['speediconshoveranimation'] == '0.1') echo "selected='selected'" ?>>0.1</option>
            <option value="0.2" <?php if ($cis_options['speediconshoveranimation'] == '0.2') echo "selected='selected'" ?>>0.2</option>
            <option value="0.3" <?php if ($cis_options['speediconshoveranimation'] == '0.3') echo "selected='selected'" ?>>0.3</option>
            <option value="0.4" <?php if ($cis_options['speediconshoveranimation'] == '0.4') echo "selected='selected'" ?>>0.4</option>
            <option value="0.5" <?php if ($cis_options['speediconshoveranimation'] == '0.5') echo "selected='selected'" ?>>0.5</option>
            <option value="0.6" <?php if ($cis_options['speediconshoveranimation'] == '0.6') echo "selected='selected'" ?>>0.6</option>
            <option value="0.7" <?php if ($cis_options['speediconshoveranimation'] == '0.7') echo "selected='selected'" ?>>0.7</option>
            <option value="0.8" <?php if ($cis_options['speediconshoveranimation'] == '0.8') echo "selected='selected'" ?>>0.8</option>
            <option value="0.9" <?php if ($cis_options['speediconshoveranimation'] == '0.9') echo "selected='selected'" ?>>0.9</option>
            <option value="1.0" <?php if ($cis_options['speediconshoveranimation'] == '1.0') echo "selected='selected'" ?>>1.0</option>
            <option value="1.1" <?php if ($cis_options['speediconshoveranimation'] == '1.1') echo "selected='selected'" ?>>1.1</option>
            <option value="1.2" <?php if ($cis_options['speediconshoveranimation'] == '1.2') echo "selected='selected'" ?>>1.2</option>
            <option value="1.3" <?php if ($cis_options['speediconshoveranimation'] == '1.3') echo "selected='selected'" ?>>1.3</option>
            <option value="1.4" <?php if ($cis_options['speediconshoveranimation'] == '1.4') echo "selected='selected'" ?>>1.4</option>
            <option value="1.5" <?php if ($cis_options['speediconshoveranimation'] == '1.5') echo "selected='selected'" ?>>1.5</option>
            <option value="1.6" <?php if ($cis_options['speediconshoveranimation'] == '1.6') echo "selected='selected'" ?>>1.6</option>
            <option value="1.7" <?php if ($cis_options['speediconshoveranimation'] == '1.7') echo "selected='selected'" ?>>1.7</option>
            <option value="1.8" <?php if ($cis_options['speediconshoveranimation'] == '1.8') echo "selected='selected'" ?>>1.8</option>
            <option value="1.9" <?php if ($cis_options['speediconshoveranimation'] == '1.9') echo "selected='selected'" ?>>1.9</option>
            <option value="2.0" <?php if ($cis_options['speediconshoveranimation'] == '2.0') echo "selected='selected'" ?>>2.0</option>
      </select>
      (<?php _e("in seconds", 'cool-image-share') ?>)
      ...
      &nbsp;&nbsp;&nbsp;<?php _e("Speed:", 'cool-image-share') ?>
      <select name="speedimagehoveranimation">
            <option value="0.1" <?php if ($cis_options['speedimagehoveranimation'] == '0.1') echo "selected='selected'" ?>>0.1</option>
            <option value="0.2" <?php if ($cis_options['speedimagehoveranimation'] == '0.2') echo "selected='selected'" ?>>0.2</option>
            <option value="0.3" <?php if ($cis_options['speedimagehoveranimation'] == '0.3') echo "selected='selected'" ?>>0.3</option>
            <option value="0.4" <?php if ($cis_options['speedimagehoveranimation'] == '0.4') echo "selected='selected'" ?>>0.4</option>
            <option value="0.5" <?php if ($cis_options['speedimagehoveranimation'] == '0.5') echo "selected='selected'" ?>>0.5</option>
            <option value="0.6" <?php if ($cis_options['speedimagehoveranimation'] == '0.6') echo "selected='selected'" ?>>0.6</option>
            <option value="0.7" <?php if ($cis_options['speedimagehoveranimation'] == '0.7') echo "selected='selected'" ?>>0.7</option>
            <option value="0.8" <?php if ($cis_options['speedimagehoveranimation'] == '0.8') echo "selected='selected'" ?>>0.8</option>
            <option value="0.9" <?php if ($cis_options['speedimagehoveranimation'] == '0.9') echo "selected='selected'" ?>>0.9</option>
            <option value="1.0" <?php if ($cis_options['speedimagehoveranimation'] == '1.0') echo "selected='selected'" ?>>1.0</option>
            <option value="1.1" <?php if ($cis_options['speedimagehoveranimation'] == '1.1') echo "selected='selected'" ?>>1.1</option>
            <option value="1.2" <?php if ($cis_options['speedimagehoveranimation'] == '1.2') echo "selected='selected'" ?>>1.2</option>
            <option value="1.3" <?php if ($cis_options['speedimagehoveranimation'] == '1.3') echo "selected='selected'" ?>>1.3</option>
            <option value="1.4" <?php if ($cis_options['speedimagehoveranimation'] == '1.4') echo "selected='selected'" ?>>1.4</option>
            <option value="1.5" <?php if ($cis_options['speedimagehoveranimation'] == '1.5') echo "selected='selected'" ?>>1.5</option>
            <option value="1.6" <?php if ($cis_options['speedimagehoveranimation'] == '1.6') echo "selected='selected'" ?>>1.6</option>
            <option value="1.7" <?php if ($cis_options['speedimagehoveranimation'] == '1.7') echo "selected='selected'" ?>>1.7</option>
            <option value="1.8" <?php if ($cis_options['speedimagehoveranimation'] == '1.8') echo "selected='selected'" ?>>1.8</option>
            <option value="1.9" <?php if ($cis_options['speedimagehoveranimation'] == '1.9') echo "selected='selected'" ?>>1.9</option>
            <option value="2.0" <?php if ($cis_options['speedimagehoveranimation'] == '2.0') echo "selected='selected'" ?>>2.0</option>
      </select>
      (<?php _e("in seconds", 'cool-image-share') ?>)
